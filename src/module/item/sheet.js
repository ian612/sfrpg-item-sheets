/**
 * Override and extend the SFRPGItemSheet implementation to use the enhanced version
 * @type {ItemSheetSFRPG}
 */
export class EnhancedItemSheetSFRPG extends sfrpg.applications.ItemSheetSFRPG {
    constructor(...args) {
        super(...args);
